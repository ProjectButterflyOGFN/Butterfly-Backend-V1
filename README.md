...
### Butterfly Backend V1 is a fortnite backend written in Node.js that features an account system and xmpp.
...
- Friends.
### NOTE: Butterfly Backend V1 does not support Save the World.
